...
class BARYPremierControleurController extends Controller
{
	...
	public function produitAction($chiffre1 , $chiffre2){
		...
		return $this->render(
			'SYM16SimpleStockBundle:BARYPremierControleur:produit.html.twig',
    ...
    $path=array(
		...
		'SYM16SimpleStockBundle:BARYPremierControleur:lister.html.twig',
